...
namespace CoreMovieAppRepeat.Data
{
    public class MovieRepository
    {
        ...
        static MovieRepository()
        {
            movies = new List<Movie>()
            {
                ...
                new Movie() {Id=5,CategoryID=2,Name="Captain Marvel",ShortDescription="Which Goose the Cat is Real? | Making Marvel Studios’ Captain Marvel",
